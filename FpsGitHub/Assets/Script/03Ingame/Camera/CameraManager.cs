...
public class CameraManager : MonoBehaviour {
    ...
    public GameObject playerCenterObject; //타겟 오브젝트

    private float smoothing = 25f;
    float camZpos = 5f; //distance
    bool zoomIn = false;
    ...
    private void followCam()
    {
        ...
        //newPosition.y = camCurrentHeight;
        //newPosition.x = camCurrentX;
    ...
    void TransCamAngle()
    {
        if(Input.GetMouseButtonDown(1)&&!zoomIn)
        {
            ...
            playerCenterObject.transform.localPosition = new Vector3(0.5f, 3f, 0f);
        }
        else if(Input.GetMouseButtonDown(1)&&zoomIn)
        {
            ...
            playerCenterObject.transform.localPosition = new Vector3(0.5f, 2.2f, 0f);
        }
    }
}
